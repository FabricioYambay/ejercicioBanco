...
public class FrmModificarCuenta extends JFrame {
    ...
    public FrmModificarCuenta() {
        ...
        btnModificar = new JButton("Elominar");
    ...
    public void btnBuscarActionListener(ActionEvent e) {
        ...
        try {
            ...
            if (cuentaDao.modificar(cuenta) > 0) {
    ...
    public static void main(String[] args) {
        ...
        FrmModificarCuenta frmMenu = new  FrmModificarCuenta ();
